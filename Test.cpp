...
int main()
{
	...
	if (signal == 0)
	{
		...
		testcase.setname("Test CalculateBull_and_pgia Succes")
				.CHECK_OUTPUT(calculateBull_And_Cows("123456789", "123456789"), "9,0") //9 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1231", "1113"), "1,2")					 //1 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1112", "2111"), "2,2")					 //2 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("6900", "9060"), "1,3")					 //1 bull,3 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1010", "1010"), "4,0")					 //4 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("222", "222"), "3,0")						 //3 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("17", "17"), "2,0")							 //2 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("11111", "11111"), "5,0")				 //5 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("3319", "1111"), "1,0")					 //1 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("2020", "2200"), "2,2")					 //2 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("6661", "1116"), "0,2")					 //0 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("33333", "33333"), "5,0")				 //5 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("9920", "2922"), "2,0")					 //2 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("3", "3"), "1,0")								 //1 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1011", "1010"), "3,0")					 //3 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("123", "301"), "0,2")						 //0 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("71", "17"), "0,2")							 //0 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("2341324", "9876348"), "1,1")		 //1 bull,1 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("5", "3"), "0,0")								 //0 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1234", "4321"), "0,4")					 //0 bull,4 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("123456789", "195864732"), "2,7") //2 bull,7 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("123456", "123456"), "6,0")			 //6 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1231", "1113"), "1,2")					 //1 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("8060", "4448"), "0,1")					 //0 bull,1 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("9999", "2292"), "1,0")					 //1 bull,0 pgia
				;

		testcase.setname("Test CalculateBull_and_pgia With error lenght ")

				.CHECK_OUTPUT(calculateBull_And_Cows("123456789", "12345678"), "8,0") //8 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1231", "111"), "1,1")						//1 bull,1 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1112", "21111"), "2,2")					//2 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("620", "9060"), "0,2")						//0 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("105", "1010"), "2,0")						//2 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("2242", "222"), "2,1")						//2 bull,1 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("137", "17"), "1,1")							//1 bull,1 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("66", "1116"), "0,0")						//0 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("3333", "33333"), "4,0")					//4 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("920", "22"), "1,0")							//1 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("38", "3"), "1,0")								//1 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("111", "1010"), "2,0")						//2 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("123", "31"), "0,2")							//0 bull,2 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("71", "1"), "0,1")								//0 bull,1 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("2341324", "98763"), "1,0")			//1 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("58", "3"), "0,0")								//0 bull,0 pgia
				.CHECK_OUTPUT(calculateBull_And_Cows("1234", "421"), "1,2")						//1 bull,2 pgia
				;
